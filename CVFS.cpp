...
// Maximmum number of files that we can open
...
void DisplayHelp()
{
    ...
    printf("man : It is used to display the specific mannual page of command\n");
    ...
    printf("unlink : It is used to delete the exixting file\n");
    printf("stat : It is used to display statistical information about file\n");
    printf("ls : It is used to list out all the files from the directory\n");
            ...
            )
{
    ...
    {
        printf("Description : This command is used to delete regular file from file system\n");
    ...
    {
        printf("Description : This command is used to display statistical information of the file\n");

        printf("Usage : stat File_name\n");
        printf("File_name : The name of file whose information that you want to display\n");
    }
    else if(strcmp(name,"ls") == 0)
    {
        printf("Description : This command is used to list all filename directory\n");
    ...
    else if(strcmp(name,"write") == 0)
    {
        ...
        printf("File_Descriptor : Its a value returned by creat system call\n");
    }
            ...
            )
{
    ...
    printf("Current inodes remainning : %d\n",superobj.FreeInodes);
    // Filters
    ...
    // decrement the number of free inodes by 1 because one created
    superobj.FreeInodes--;
...
//  Description :       It is used to display the information about given one file
            ...
            )
{
    ...
    while(temp != NULL)
    {
        ...
        {
            printf("--------------------------------------------------------\n");
            printf("-----------Statictical Information of file--------------\n");
            printf("--------------------------------------------------------\n");
...
//  Input :             It accepts file descriptor (fd), Address of Buffer (contains data),
//                      Size of data that we want to write
//  Output :            It returns Number of bytes successfully written into the file
//  Author :            Tushar Vijay Shirsat
//  Date :              15/08/2025
//
///////////////////////////////////////////////////////////////////////

//Marvellous CVFS > write 2(fd)
            ...
            )
{
    ...
    // File is opened or created with the given fd
    ...
    // update the actual size of the file after writing the new data
...
//  Input :             It accepts file descriptor (fd), Address of empty Buffer (no data),
//                      Size of data that we want to write
//  Output :            It returns Number of bytes successfully read from the file
//  Author :            Tushar Vijay Shirsat
//  Date :              15/08/2025
//
///////////////////////////////////////////////////////////////////////

//Marvellous CVFS > read 2(fd) 10(size)

int read_File(
                int fd,                // File descriptor
                char *data,            // Address of empty buffer
                int size               // Number of bytes that you wwant to read
            )
{
    // Invalid value of fd
    if(fd < 0 || fd > MAXOPENEDFILES)
...
int main()
{
    ...
    int iCount = 0;
    int iRet = 0;
    char Command[5][80];                        // tokenization of commands
    char InputBuffer[MAXFILESIZE] = {'\0'};          // to write the data
    char *EmptyBuffer = NULL;                       // to read data from file take empty tin
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            else if(strcmp(Command[0], "write") == 0)
            {
                ...
                {
                    printf("Error : Insufficient space int the data block of the file\n");
                }
